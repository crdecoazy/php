<?php 
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"sakthibala auto works",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"gandhi nagar,",0,1);
      $this->Cell(50,7,"Aruppukottai 626101.",0,1);
      $this->Cell(50,7,"PH : 8675782783",0,1);
    ...
    function body($info,$products_info){
      ...
      $this->Cell(50,7,$info["vechile_no"],0,1);
      $this->Cell(50,7,$info["km"],0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for sakthibala auto works",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
